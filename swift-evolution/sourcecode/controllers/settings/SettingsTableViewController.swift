...
final class SettingsTableViewController: UITableViewController {
  ...
  private func buildDataSource() {
    ...
    //    footerDescription = "You need to authorize Notifications for Evolution App before the switch be enabled.
    //    Settings > Notifications > Evolution > Allow Notifications."
    // }
    //
